...
class Login extends Component{
  ...
  loadingbtn = () => (
    <button disabled="" type="button" class="bg-blue-700  text-white font-bold py-2 px-4 w-full rounded hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-700  text-sm  text-center mr-2 dark:bg-blue-700 dark:hover:bg-blue-700 dark:focus:ring-blue-800 flex justify-center items-center">
    <svg aria-hidden="true" role="status" class="inline mr-3 w-4 h-4 font-bold text-white animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
