  ...
  render() {
    ...
    return (
      <>
        ...
        <div className="flex justify-between md:justify-end p-2 md:p-4">
          <button
            onClick={this.toggleSidebar}
            type="button"
            className="pl-3 text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
          >
          ...
          <nav className="md:ml-64 text-xl p-2 mt-2 hidden md:block">
            <p className="text-md font-black md:text-xl">
        ...
        >
          <div className="min-h-screen px-3 py-4 flex flex-col justify-between overflow-y-auto bg-gray-50 dark:bg-gray-800">
            <ul className="space-y-2 font-medium md:mt-7">
              ...
              <li className="py-2 md:hidden text-end">
                <button
